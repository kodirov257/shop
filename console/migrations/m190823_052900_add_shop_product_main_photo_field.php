...
/**
 * Class m190823_052900_add_shop_product_main_photo_field
 */
class m190823_052900_add_shop_product_main_photo_field extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->addColumn('{{%shop_products}}', 'main_photo_id', $this->integer()->after('price_new'));
    ...
    {
        echo "m190823_052900_add_shop_product_main_photo_field cannot be reverted.\n";
